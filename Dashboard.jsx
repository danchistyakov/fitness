...
import {
  Users, TrendingUp, DollarSign, Activity, Calendar,
...
const Dashboard = () => {
  ...
  if (!dashboardData || summary.total_clients === 0) {
    return (
      <div>
        ...
        <div className="card" style={{ textAlign: 'center', padding: '48px' }}>
          ...
          <button className="btn btn-primary" onClick={generateDemoData}>
    ...
    <div>
      ...
      <div className="stats-grid">
        ...
        <StatCard
          ...
          changeType={summary.revenue_growth >= 0 ? 'positive' : 'negative'}
          variant="info"
        />
        <StatCard
          title="Тренировок за 30 дней"
        ...
        <StatCard
          ...
          value={formatNumber(summary.avg_satisfaction, 1)}
          icon={Star}
          variant="warning"
        />
      </div>
      ...
      <div className="charts-grid">
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={dashboardData?.weekly_visits || []}>
              <defs>
              ...
              <XAxis 
                ...
                tickFormatter={(value) => value.split('-')[1] ? `Нед ${value.split('-')[1]}` : value}
              />
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={dashboardData?.subscription_distribution || []}
                cx="50%"
                cy="50%"
                innerRadius={60}
                outerRadius={100}
              ...
              >
                {(dashboardData?.subscription_distribution || []).map((entry, index) => (
      ...
      <div className="charts-grid">
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={dashboardData?.visits_by_weekday || []}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
        ...
        <div className="chart-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {(dashboardData?.top_trainers || []).map((trainer, index) => (
              <div 
                key={index}
                style={{
                  display: 'flex',
      ...
      {recommendations?.recommendations?.length > 0 && (
        <div style={{ marginTop: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
            Потенциальный дополнительный доход: {formatCurrency(recommendations.total_potential_impact)}
          </p>
            ...
            <div key={index} className="recommendation-card">
              ...
              <div className="recommendation-content">
                ...
                <span className="recommendation-impact">
                  +{formatCurrency(rec.potential_impact)} потенциальный доход
                </span>
              </div>
            </div>
          ))}
